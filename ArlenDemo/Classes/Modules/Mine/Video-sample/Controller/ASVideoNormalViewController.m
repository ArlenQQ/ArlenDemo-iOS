...
@implementation ASVideoNormalViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.videoURL = @"http://tb-video.bdstatic.com/videocp/12045395_f9f87b84aaf4ff1fee62742f2d39687f.mp4";
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.as_navgationBar.hidden = true;
    // pop回来时候是否自动播放
