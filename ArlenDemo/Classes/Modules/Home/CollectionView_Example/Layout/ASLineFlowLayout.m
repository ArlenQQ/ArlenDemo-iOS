...
static const CGSize AS_itemSize_ = {140, 140};

@interface ASLineFlowLayout ()

@end

@implementation ASLineFlowLayout
...
#pragma mark - ASLineFlowLayoutDelegate

- (id<ASLineFlowLayoutDelegate>)delegate
{
    return (id<ASLineFlowLayoutDelegate>)self.collectionView.dataSource;
}
