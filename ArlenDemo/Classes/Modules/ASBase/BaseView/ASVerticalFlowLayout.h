...
@class ASVerticalFlowLayout;


@protocol ASVerticalFlowLayoutDelegate <NSObject>
 ...
 *  列间距, 默认10
 */
- (CGFloat)waterflowLayout:(ASVerticalFlowLayout *)waterflowLayout columnsMarginInCollectionView:(UICollectionView *)collectionView;
/**
 *  行间距, 默认10
 */
 ...
 */
- (UIEdgeInsets)waterflowLayout:(ASVerticalFlowLayout *)waterflowLayout edgeInsetsInCollectionView:(UICollectionView *)collectionView;
...
@interface ASVerticalFlowLayout : UICollectionViewLayout
