//
//  ASRefreshTableViewController.m
//  PLMMPRJK
//
...
#import "ASRefreshTableViewController.h"


@interface ASRefreshTableViewController ()

@end

@implementation ASRefreshTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    @WeakObj(self);
    self.tableView.mj_header = [ASNormalRefreshHeader headerWithRefreshingBlock:^{
        
        [selfWeak loadIsMore:NO];
    }];
    self.tableView.mj_footer = [ASAutoRefreshFooter footerWithRefreshingBlock:^{
