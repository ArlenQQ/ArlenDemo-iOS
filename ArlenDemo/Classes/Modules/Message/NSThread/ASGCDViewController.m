...
- (void)viewDidLoad {
    ...
    ASWordItem *item0 = [ASWordItem itemWithTitle:@"并发队列 + 同步函数" subTitle:nil];
    [item0 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak syncConCurrent];
    }];
    
    ASWordItem *item1 = [ASWordItem itemWithTitle:@"并发队列 + 异步函数" subTitle:nil];
    [item1 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak asyncConcurrent];
    }];
    
    ASWordItem *item2 = [ASWordItem itemWithTitle:@"串行队列 + 同步函数" subTitle:nil];
    [item2 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak syncSerial];
    }];
    
    ASWordItem *item3 = [ASWordItem itemWithTitle:@"串行队列 + 异步函数" subTitle:nil];
    [item3 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak asyncSerial];
    }];
    
    ASWordItem *item4 = [ASWordItem itemWithTitle:@"主队列 + 同步函数--相互等待" subTitle:@"直接闪退"];
    [item4 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak syncMain];
    }];
    
    ASWordItem *item5 = [ASWordItem itemWithTitle:@"主队列 + 异步函数" subTitle:nil];
    [item5 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak asyncMain];
    }];
    
    ASWordItem *item6 = [ASWordItem itemWithTitle:@"全局队列+ 异步函数" subTitle:nil];
    [item6 setItemOperation:^(NSIndexPath *indexPath) {
        [selfWeak asyncGloba];
    }];
    
    ASItemSection *section0 = [ASItemSection sectionWithItems:@[item0, item1, item2, item3, item4, item5, item6] andHeaderTitle:@"六种类型：" footerTitle:nil];
    ASItemSection *section1 = [ASItemSection sectionWithItems:nil andHeaderTitle:@"多种 GCD" footerTitle:nil];
    
    
    ASWordItem *item10 = [ASWordItem itemWithTitle:@"dispatch_barrier_async" subTitle:@"栅栏函数"];
    ...
    ASWordItem *item11 = [ASWordItem itemWithTitle:@"dispatch_apply" subTitle:@"快速迭代"];
    item11.itemOperation = ^(NSIndexPath *indexPath) {
        [selfWeak apply];
    };
    
    ASWordItem *item12 = [ASWordItem itemWithTitle:@"dispatch_group_t" subTitle:@"队列组和线程通讯"];
    ...
    ASWordItem *item20 = [ASWordItem itemWithTitle:@"dispatch_source_t" subTitle:@"GCD 定时器"];
    ...
    [self.sections addObject:[ASItemSection sectionWithItems:@[item20] andHeaderTitle:@"other" footerTitle:nil]];
...
-(void)syncConCurrent{
    ...
    dispatch_queue_t queue= dispatch_queue_create("arlen.s.queue", DISPATCH_QUEUE_CONCURRENT);
...
-(void)asyncConcurrent{
    ...
    dispatch_queue_t queue= dispatch_queue_create("arlen.s.asyncqueue", DISPATCH_QUEUE_CONCURRENT);
...
-(void)syncSerial{
    ...
    dispatch_queue_t queue = dispatch_queue_create("arlen.s.syncSerial", DISPATCH_QUEUE_SERIAL);
...
-(void)asyncSerial{
    ...
    dispatch_queue_t queue = dispatch_queue_create("arlen.s.asyncSerial", DISPATCH_QUEUE_SERIAL);
...
-(void)asyncMain{
    ...
    NSLog(@"asyncSerial---end");
//    2018-06-26 16:39:01.383132+0800 ArlenDemo[1926:651039] asyncSerial---end
//    2018-06-26 16:39:01.388370+0800 ArlenDemo[1926:651039] 1------<NSThread: 0x170073440>{number = 1, name = main}
//    2018-06-26 16:39:01.388608+0800 ArlenDemo[1926:651039] 1------<NSThread: 0x170073440>{number = 1, name = main}
//    2018-06-26 16:39:01.388753+0800 ArlenDemo[1926:651039] 2------<NSThread: 0x170073440>{number = 1, name = main}
//    2018-06-26 16:39:01.388881+0800 ArlenDemo[1926:651039] 2------<NSThread: 0x170073440>{number = 1, name = main}
//    2018-06-26 16:39:01.389013+0800 ArlenDemo[1926:651039] 3------<NSThread: 0x170073440>{number = 1, name = main}
//    2018-06-26 16:39:01.389136+0800 ArlenDemo[1926:651039] 3------<NSThread: 0x170073440>{number = 1, name = main}
}
-(void)asyncGloba{
